    ...
    <ScrollView style={styles.container}>
      <View style={styles.sliderContainer}>
        ...
        //   horizontal={false}
          ...
          <View style={styles.slide}>
            <Image
              source={require('../assets/image/food-banner1.jpg')}
              resizeMode="cover"
          ...
          <View style={styles.slide}>
            <Image
              source={require('../assets/image/food-banner2.jpg')}
              resizeMode="cover"
              style={styles.sliderImage}
            />
          </View>
          <View style={styles.slide}>
            <Image
              source={require('../assets/image/food-banner3.jpg')}
              resizeMode="cover"
              style={styles.sliderImage}
            />
          </View>
      ...
      <View style={styles.cardsWrapper}>
        ...
        <View style={styles.card}>
          <View style={styles.cardImgWrapper}>
            <Image
              source={require('../assets/image/food-banner4.jpg')}
              resizeMode="cover"
              style={styles.cardImg}
            />
          </View>
